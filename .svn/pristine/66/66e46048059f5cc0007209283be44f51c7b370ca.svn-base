...
<html>
  ...
  <body class="easyui-layout" >
	    <div data-options="region:'north'" style="height:70px;background:#2670b4;border: 0px"  >
	        <img src="${path}/image/logo.JPG" style="height:70px"></img>
					...
					<div class="sideba_a fl bg3" id="pLoginHisInfo">
					    <ul class="mess fl">
							<li>
								...
								<span class="fl">
								  <a href='mailto:Zowee_messupport@zowee.com.cn'  class="fontcolor7">
											Zowee_messupport@zowee.com.cn
								   </a>
				 ...
				 <div class="subcolu1 bg2 fl ml2">
					<div class="sideba_a fl bg3">
						<ul class="mess fl">
						    <li>
							    <span class="meshelp">
										<a href='http://172.30.44.57/mesplus-zy/home/home' target="_blank" class="fontcolor7">
							...
							<li>
							    <span class="meshelp">
										<a href='http://172.30.44.57/mesplus-zy/home/opc' target="_blank" class="fontcolor5">
											<b class="helpicon2 fl"></b>
											华为OPC
										</a>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<li>
							    <span class="meshelp">
										<a href='http://192.168.2.7/wui/main.jsp' target="_blank" class="fontcolor2">
											<b class="helpicon1 fl"></b>
											办公系统
										</a>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								...
								<li>
							    <span class="meshelp">
										<a href='http://10.2.0.17:8080/mes' target="_blank" class="fontcolor3">
											<b class="helpicon2 fl"></b>
											电子看板
										</a>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;工厂生产电子看板系统
								...
								<li>
							    <span class="meshelp">
										<a href='http://10.2.0.17:8080/bbs' target="_blank" class="fontcolor4">
											<b class="helpicon1 fl"></b>
											卓翼BBS
										</a>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;卓翼论坛系统
